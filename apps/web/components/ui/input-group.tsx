...
export function InputGroup({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: 输入框与前后缀的排版容器，<fieldset> 的表单语义在这里是错的
    <div
      className={cn(
...
export function InputGroupAddon({
  ...
  return (
    // biome-ignore lint/a11y/noStaticElementInteractions: 只用 mousedown 把焦点转交给相邻的 input，自身不是可交互控件，键盘用户直接聚焦 input
    <div
