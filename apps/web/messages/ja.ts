...
export const jaMessages: LocaleContent = {
  ...
  pdfPasswordRemover: {
    metadata: {
      description:
        "パスワード付きの PDF をアップロードしてパスワードを入力するだけで、パスワードを解除した内容がまったく同じ PDF をダウンロードできます。すべての処理はブラウザ内で完結し、ファイルがサーバーへ送信されることはありません。",
      keywords: [
        "PDF パスワード解除",
        "PDF パスワード削除",
        "PDF 復号",
      ...
      title: "オンライン PDF パスワード解除",
    },
    hero: {
      badges: {
        category: "ドキュメントツール",
        localProcessing: "ブラウザ内で処理",
        noUpload: "ファイルは端末から出ません",
      },
      description:
        "パスワード付きの PDF をアップロードし、ご存じのパスワードを入力すると、パスワードを解除した内容がまったく同じ新しいファイルが手に入ります。復号はすべてブラウザ内で完結し、ファイルがお使いの端末を離れることはありません。",
      title: "オンラインで PDF のパスワードを解除",
    },
    scenarios: {
      description:
        "パスワードは分かっていて、開くたびに入力する手間だけをなくしたい方に最適です。",
      knownPassword:
        "PDF のパスワードは分かっているが、開くたびに入力し直したくない。",
      permission:
        "PDF に印刷・コピー・編集の制限が設定されていて、その権限制限を解除したい。",
      privacy:
        "契約書や請求書など機密情報を含む PDF で、第三者のサーバーにアップロードして復号したくない。",
      title: "こんな場面に最適",
    },
    tool: {
      category: "ドキュメントツール",
      description:
        "パスワード付きの PDF をアップロードしてパスワードを入力するだけで、パスワードを解除した内容がまったく同じ PDF をダウンロードできます。すべての処理はブラウザ内で完結し、ファイルがサーバーへアップロードされることはありません。",
      faq: [
        {
          answer:
            "送信しません。PDF の復号と書き出しはすべてお使いのブラウザ内で行われ、どのサーバーにも送信されません。",
          question: "私の PDF はサーバーにアップロードされますか？",
        },
        {
          answer:
            "できません。本ツールはパスワードの総当たり解析は行いません。復号には正しいパスワードを知っている必要があります。パスワードを忘れた PDF は解除できません。",
          question: "パスワードを忘れても解析してもらえますか？",
        },
        {
          answer:
            "処理できます。PDF に印刷・コピー・編集などの権限制限（所有者パスワード）だけが設定されている場合は、パスワードを入力しなくても自動で制限を解除します。",
          question: "印刷・コピー制限だけの PDF も処理できますか？",
        },
        {
          answer:
            "変わりません。復号は暗号化情報を取り除くだけで、ページの内容・文字・画像・レイアウトはそのまま保持されます。",
          question: "復号後に内容は変わりますか？",
        },
      ],
      features: [
        "正しいパスワードを入力すると PDF の開くパスワードを解除",
        "印刷・コピー・編集の権限制限のみの場合は自動で解除",
        "復号後も内容とレイアウトは元のファイルとまったく同じ",
        "初回利用時にのみ復号エンジンを必要に応じて読み込み",
        "すべてブラウザ内で処理し、ファイルは端末から出ません",
      ],
      keywords: [
        "PDF パスワード解除",
        "PDF パスワード削除",
      ...
      name: "オンライン PDF パスワード解除",
      steps: [
        "パスワード付きの PDF をアップロードします。",
        "パスワードの入力を求められたら、ご存じの正しいパスワードを入力します。",
        "ブラウザ内で復号が完了するのを待ちます。",
        "ダウンロードをクリックして、パスワードを解除した PDF を保存します。",
      ],
      summary:
        "ブラウザ内で PDF のパスワードを解除し、内容がまったく同じ新しいファイルを手に入れます。",
    },
    content: {
      faqDescription: "始める前によくある質問をまとめました。",
      faqTitle: "よくある質問",
      limitsDescription: "以下の場合には現時点で対応していません。",
      limitsItems: [
        "パスワードを忘れた PDF：本ツールは総当たり解析を行わないため、正しいパスワードが必要です。",
        "破損している、または非標準の PDF：正しく解析できない場合があります。",
        "{size} を超えるファイル：分割または圧縮してから処理してください。",
      ],
      limitsTitle: "既知の制限",
      stepsDescription: "下記の手順に従うだけでパスワードを解除できます。",
      stepsTitle: "使い方",
      supportDescription:
        "ツールが PDF の暗号化タイプを自動で判別します。パスワードが必要なものは入力を求め、権限制限のみのものは自動で解除します。",
      supportTitle: "ツールの機能",
    },
    client: {
      badges: {
        localProcessing: "ブラウザ内で処理",
        noUpload: "ファイルは端末から出ません",
        supportedFormats: "PDF に対応",
      },
      upload: {
        choosePdf: "PDF を選択",
        clear: "クリア",
        description:
          "下のエリアに PDF をドラッグするか、ボタンをクリックしてファイルを選択してください。処理がブラウザを離れることはありません。",
        emptyDescription:
          "パスワード付き、または権限制限のある PDF に対応しています。",
        emptyTitle: "PDF をドロップしてパスワード解除を開始",
        maxSizeHint: "1 ファイルあたり {size} まで。",
        reselect: "選び直す",
        title: "PDF をアップロード",
      },
      loading: {
        description:
          "初回利用時に約 1.3MB の復号コンポーネントをダウンロードします。以降はブラウザにキャッシュされ、再ダウンロードは不要です。",
        failed:
          "復号エンジンの読み込みに失敗しました。ネットワークを確認して再試行してください。",
        progress: "{percent}% ダウンロード済み",
        retry: "再試行",
        title: "復号エンジンを読み込み中",
      },
      password: {
        description:
          "この PDF を開くにはパスワードが必要です。ご存じのパスワードを入力してください。",
        label: "PDF パスワード",
        placeholder: "開くパスワードを入力",
        submit: "復号する",
        submitting: "復号中",
        title: "PDF のパスワードを入力",
      ...
      status: {
        decrypting: "復号中…",
        detecting: "PDF の暗号化状態を検出中…",
      },
      result: {
        downloadButton: "パスワードを解除した PDF をダウンロード",
        notEncryptedSuccess:
          "この PDF はそもそも暗号化されていません。処理は不要で、元のファイルをそのままダウンロードできます。",
        ownerOnlySuccess:
          "この PDF の印刷・コピー・編集制限を解除しました。そのままダウンロードできます。",
        privacyNote:
          "復号はすべて端末内で完結し、ファイルがお使いの端末を離れることはありません。",
        title: "処理が完了しました",
        userPasswordSuccess:
          "パスワードを解除しました。内容がまったく同じ新しいファイルをそのままダウンロードできます。",
      },
      errors: {
        decryptFailed:
          "復号に失敗しました。ファイルが破損していないか確認して再試行してください。",
        decryptFailedDetail: "復号に失敗しました：{detail}",
        fileTooLarge:
          "ファイルが大きすぎます。最大 {size} まで対応しています。",
        invalidPassword:
          "パスワードが正しくありません。もう一度お試しください。",
        loadFailed:
          "復号エンジンの読み込みに失敗しました。ネットワークを確認して再試行してください。",
        unsupportedFormat:
          "このファイル形式には対応していません。PDF をアップロードしてください。",
      },
    },
  },
  ogImageValidator: {
  ...
  chineseConverter: {
    metadata: {
      description:
        "簡体字中国語と繁体字中国語をオンラインで相互変換。標準繁体字、台湾正体字、香港・マカオ繁体字の地域語彙変換に対応。変換はすべてブラウザ内で完結し、内容はアップロードされません。",
      keywords: [
        "簡体字 繁体字 変換",
        "簡体字 繁体字",
        "繁体字 簡体字",
      ...
      title: "簡体字・繁体字変換 - オンライン中国語コンバーター",
    },
    hero: {
      badges: {
        category: "テキストツール",
        localProcessing: "ブラウザ内でローカル処理",
        regionalAware: "台湾・香港の語彙に対応",
      },
      description:
        "簡体字中国語と繁体字中国語を相互変換。繁体字側では標準・台湾正体・香港/マカオ繁体字を選択でき、地域語彙（例：软件 ↔ 軟體）も自動的に変換されます。変換はすべてブラウザ内で完結し、内容はアップロードされません。",
      title: "簡体字・繁体字 オンライン変換",
    },
    scenarios: {
      description:
        "日常的な簡体字・繁体字変換や地域化に向いています。古典文献や異体字の考証には向いていません。",
      localize:
        "台湾や香港のユーザー向けに文言をローカライズしたい（例：「軟件」ではなく「軟體」を使いたい）。",
      publish:
        "簡体字で書いた内容を、香港・マカオ・台湾の読者向けに繁体字版として公開したい。",
      read: "繁体字の資料をさっと簡体字に変換して読みやすくしたい。",
      title: "こんな場面に",
    },
    tool: {
      category: "テキストツール",
      description:
        "簡体字中国語と繁体字中国語をオンラインで変換：標準繁体字、台湾正体字（地域語彙対応）、香港/マカオ繁体字（地域語彙対応）の3種類から選択でき、変換方向もワンクリックで切り替え可能。すべてブラウザ内で処理され、内容はアップロードされません。",
      faq: [
        {
          answer:
            "いいえ。すべての変換はブラウザ内でローカルに行われ、内容がサーバーに送信されることはありません。",
          question: "内容はサーバーにアップロードされますか？",
        },
        {
          answer:
            "標準繁体字は文字の変換のみを行います（例：汉→漢）。台湾正体字と香港/マカオ繁体字はそれに加えて地域特有の語彙も変換します（例：软件→軟體 または 軟件）。現地の読者の表現によりマッチします。",
          question:
            "「標準繁体字」と「台湾正体字」「香港/マカオ繁体字」は何が違いますか？",
        },
        {
          answer:
            "辞書ルールに基づいて変換するため、日常的な語彙のほとんどをカバーしますが、固有名詞・人名・新語すべてには対応できません。正式に公開する前にネイティブによる確認をおすすめします。",
          question: "変換結果は常に正確ですか？",
        },
        {
          answer:
            "対応しています。「繁体字→簡体字」を選択すれば、台湾正体字や香港/マカオ繁体字の地域語彙も正しく対応する簡体字に変換されます。",
          question: "繁体字から簡体字への変換にも対応していますか？",
        },
      ],
      features: [
        "簡体字→繁体字、繁体字→簡体字の双方向変換",
        "繁体字側は標準・台湾正体字・香港/マカオ繁体字の3種類の地域語彙に対応",
        "文字だけでなく地域語彙も変換（例：软件→軟體、网络→網路）",
        "ワンクリックで変換方向を切り替え、入力と出力の入れ替えも可能",
        "ブラウザ内でローカル処理、内容はアップロードされません",
        "変換結果をワンクリックでコピー",
      ],
      keywords: [
        "簡体字 繁体字 変換",
      ...
      name: "簡体字・繁体字 オンライン変換",
      steps: [
        "変換したい中国語のテキストを貼り付けるか入力します。",
        "変換方向（簡体字→繁体字 または 繁体字→簡体字）を選び、繁体字への変換なら対象地域も選びます。",
        "右側に変換結果がすぐに表示されるので、コピーしてご利用ください。",
      ],
      summary:
        "標準・台湾・香港/マカオの地域語彙に対応した簡体字・繁体字変換を、ブラウザ内でローカルに実行します。",
    },
    content: {
      faqDescription: "始める前によくある質問です。",
      faqTitle: "よくある質問",
      privacyDescription: "利用前に以下をご確認ください。",
      privacyItems: [
        "変換はすべてブラウザ内で完結し、内容がサーバーにアップロードされることはありません。",
        "地域語彙の変換は辞書ルールに基づくため、固有名詞・人名・新語すべてには対応できません。",
        "正式な公開に使う前に、ネイティブによる確認をおすすめします。",
      ],
      privacyTitle: "ご利用にあたって",
      stepsDescription: "以下の手順で変換できます。",
      stepsTitle: "使い方",
      supportDescription:
        "日常的な執筆・公開・ローカライズで最もよく使われる場面をカバーします。",
      supportTitle: "対応している変換",
    },
    client: {
      direction: {
        toSimplified: "繁体字 → 簡体字",
        toTraditional: "簡体字 → 繁体字",
      },
      empty: {
        description:
          "左側に中国語のテキストを入力または貼り付けると、ここに変換結果が表示されます。",
        title: "テキストを入力して変換を開始",
      },
      error:
        "変換に失敗しました。もう一度お試しいただくか、ページを更新してください。",
      input: {
        clear: "クリア",
        placeholder:
          "変換したい中国語のテキストをここに入力または貼り付けてください…",
        title: "入力",
      },
      output: {
        title: "変換結果",
