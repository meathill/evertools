export const zhMessages = {
  ...
  imageConverter: {
    ...
    scenarios: {
      description: "适合快速转换、改尺寸和导出常见图片，不适合复杂修图。",
    ...
    client: {
      ...
      settings: {
        ...
        presetNames: {
          ...
          googlePlayFeature: "Google Play 置顶大图",
          googlePlayPhone: "Google Play 手机截图",
          hd: "HD 720p",
          instagramSquare: "Instagram 方图",
          ipadProTwelvePointNine: "iPad Pro 12.9 英寸",
          iphoneFivePointFive: "iPhone 5.5 英寸",
          iphoneSixPointFive: "iPhone 6.5 英寸",
          iphoneSixPointNine: "iPhone 6.9 英寸",
          ogImage: "OG 分享图",
          qhd: "2K QHD",
          svga: "SVGA",
          twitterCard: "X/Twitter 卡片",
          wechatCover: "公众号封面",
          xiaohongshuPortrait: "小红书竖图",
          youtubeCover: "YouTube 封面",
        },
        quality: "输出质量",
        qualityAria: "输出质量",
        qualityDescription:
  ...
  chineseConverter: {
    metadata: {
      description:
        "在线简体中文与繁体中文互转工具，支持标准繁体、台湾正体、港澳繁体三种地区惯用词转换。转换全程在浏览器本地完成，内容不会上传。",
      keywords: [
        "简繁转换",
        "简体转繁体",
        "繁体转简体",
    ...
    hero: {
      badges: {
        category: "文本工具",
        localProcessing: "浏览器本地处理",
        regionalAware: "支持台湾/港澳用词",
      },
      description:
        "简体中文与繁体中文互转，繁体一侧可选标准、台湾正体或港澳繁体，自动转换地区惯用词（如「软件」↔「軟體」）。转换全程在浏览器本地完成，内容不会上传。",
      title: "在线简繁体转换",
    },
    scenarios: {
      description:
        "适合日常文本的简繁互转和地区化，不适合专业古籍或异体字考据场景。",
      localize:
        "把文案本地化给台湾或香港用户，需要贴合当地惯用词（如「軟體」而非「軟件」）。",
      publish: "写好的简体内容需要发布繁体版本，给港澳台读者阅读。",
      read: "看到一篇繁体资料，想快速转换成简体方便阅读理解。",
      title: "适合这些情况",
    },
    tool: {
      category: "文本工具",
      description:
        "在线转换简体中文与繁体中文：支持标准繁体、台湾正体（含地区惯用词）、港澳繁体（含地区惯用词）三种目标，一键切换转换方向。全程在浏览器本地处理，内容不上传。",
      faq: [
        {
          answer:
            "不会。所有转换都在你的浏览器本地完成，内容不会发送到服务器。",
          question: "我的内容会上传服务器吗？",
        },
        {
          answer:
            "标准繁体只做字符转换（如「汉」→「漢」）；台湾正体、港澳繁体在此基础上还会转换地区惯用词汇（如「软件」→「軟體」或「軟件」），更贴近当地读者的表达习惯。",
          question: "「标准繁体」和「台湾正体」「港澳繁体」有什么区别？",
        },
        {
          answer:
            "工具基于词典规则转换，能覆盖绝大多数常用字词，但无法覆盖所有专有名词、人名或新造词，正式发布前建议由母语者复核。",
          question: "转换结果一定准确吗？",
        },
        {
          answer:
            "支持。选择「繁体→简体」方向即可，台湾正体、港澳繁体的地区惯用词也能正确转换回对应的简体词汇。",
          question: "支持繁体转简体吗？",
        },
      ],
      features: [
        "简体转繁体、繁体转简体双向转换",
        "繁体侧支持标准、台湾正体、港澳繁体三种地区惯用词",
        "地区惯用词转换（如「软件」→「軟體」「网络」→「網路」）而非仅字符替换",
        "一键切换转换方向，支持交换输入输出",
        "浏览器本地处理，内容不上传",
        "一键复制转换结果",
      ],
      ...
      steps: [
        "粘贴或输入需要转换的中文内容。",
        "选择转换方向（简→繁 或 繁→简），如为繁体再选择目标地区。",
        "右侧会立即显示转换结果，点击复制即可使用。",
      ],
      summary:
        "在浏览器本地转换简体与繁体中文，支持标准/台湾/港澳三种繁体地区惯用词。",
    },
    content: {
      faqDescription: "开始前常见的几个问题。",
      faqTitle: "常见问题",
      privacyDescription: "使用前先了解这些说明。",
      privacyItems: [
        "转换全程在浏览器本地完成，内容不会上传到服务器。",
        "地区惯用词转换基于词典规则，无法覆盖所有专有名词、人名或新造词。",
        "转换结果建议由母语者复核后再用于正式发布场合。",
      ],
      privacyTitle: "使用说明",
      stepsDescription: "按下面的步骤即可完成转换。",
      stepsTitle: "使用方法",
      supportDescription: "覆盖日常写作、内容发布和本地化最常用的场景。",
      supportTitle: "支持的转换",
    },
    client: {
      direction: {
      ...
      empty: {
        description: "在左侧输入或粘贴中文内容，这里会显示转换后的结果。",
        title: "输入内容开始转换",
      },
      error: "转换失败，请稍后重试或刷新页面。",
      input: {
        clear: "清空",
        placeholder: "在这里输入或粘贴需要转换的中文内容…",
        title: "输入内容",
      },
      output: {
        title: "转换结果",
